      ...
      <section className="models-section">
        ...
        <div className="container">
          <div className="models-div">
            ...
            <div className="models-div__box">
              <div className="models-div__box__Image">
                <Image src={CarImage2} alt="car_Image" />
                <div className="models-div__box__descr">
                  <div className="models-div__box__descr__name-price">
                    <div className="models-div__box__descr__name-price__name">
                      <p>Golf 6</p>
            ...
            <div className="models-div__box">
              <div className="models-div__box__Image">
                <Image src={CarImage3} alt="car_Image" />
                <div className="models-div__box__descr">
                  <div className="models-div__box__descr__name-price">
                    <div className="models-div__box__descr__name-price__name">
                      <p>hrefyota</p>
            ...
            <div className="models-div__box">
              <div className="models-div__box__Image">
                <Image src={CarImage4} alt="car_Image" />
                <div className="models-div__box__descr">
                  <div className="models-div__box__descr__name-price">
                    <div className="models-div__box__descr__name-price__name">
                      <p>BMW 320</p>
            ...
            <div className="models-div__box">
              <div className="models-div__box__Image">
                <Image src={CarImage5} alt="car_Image" />
                <div className="models-div__box__descr">
                  <div className="models-div__box__descr__name-price">
                    <div className="models-div__box__descr__name-price__name">
                      <p>Mercedes</p>
            ...
            <div className="models-div__box">
              <div className="models-div__box__Image">
                <Image src={CarImage6} alt="car_Image" />
                <div className="models-div__box__descr">
                  <div className="models-div__box__descr__name-price">
                    <div className="models-div__box__descr__name-price__name">
                      <p>VW Passat</p>
